    ...
    <form class="forecreateOrder" method="post">
        ...
        <div class="productList">
                    ...
                    <c:forEach items="${ois}" var="oi" varStatus="st">
                        <tr class="orderItemTR">
                            <td class="orderItemFirstTD">
                                <img class="orderItemImg" src="img/productSingle_middle/${oi.product.imageId}.jpg">
                            </td>
                            <td class="orderItemProductInfo">
                                <a href="foreproduct?pid=${oi.pid}" class="orderItemProductLink">
                                    ${oi.product.name}
                                </a>
                            ...
                            <td>
                                <span class="orderItemProductPrice">
                                    ¥<fmt:formatNumber type="number" value="${oi.product.promotePrice}" minFractionDigits="2"></fmt:formatNumber>
                                </span>
                            </td>
                            <td>
            ...
            <div class="orderItemSumDiv">
                ...
                <span class="pull-right">合计(含运费)：¥<fmt:formatNumber type="number" value="${total}" minFractionDigits="2"></fmt:formatNumber></span>
            </div>
        </div>
        ...
        <div class="orderItemTotalSumDiv">
            <div class="pull-right">
                ...
                <span class="orderItemTotalSumSpan">
                    ¥<fmt:formatNumber type="number" value="${total}" minFractionDigits="2"></fmt:formatNumber>
                </span>
            </div>
        </div>
