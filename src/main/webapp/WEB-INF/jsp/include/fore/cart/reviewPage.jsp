...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="img/productSingle/${p.imageId}.jpg"></div>
        ...
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                ...
                <tr>
                    <td>月销量：</td>
                    <td><span class="reviewProductInfoTableSellNumber">${p.salesCount}</span>件</td>
                </tr>
            </table>
            ...
            <div class="reviewProductInfoRightBelowDiv">
                ...
                <span class="reviewProductInfoRightBelowText">
                    现在查看的是 您所购买商品的信息 于<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd日"></fmt:formatDate>下单购买此商品
                </span>
            </div>
        </div>
        ...
        <div class="reviewDivlistReviews">
            <c:forEach items="${reviews}" var="r">
                <div class="reviewDivlistReviewsEach">
                    <div class="reviewDate"><fmt:formatDate value="${r.createDate}" pattern="yyyy-MM-dd"></fmt:formatDate></div>
