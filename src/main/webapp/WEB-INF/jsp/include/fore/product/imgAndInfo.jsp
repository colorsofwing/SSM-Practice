...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img class="bigImg" src="img/productSingle/${p.imageId}.jpg">
        ...
        <div class="productPrice">
            ...
            <div class="productPriceDiv">
                ...
                <div class="originalDiv">
                    ...
                    <span class="promotionDiv"><fmt:formatNumber type="number" value="${p.originalPrice}" minFractionDigits="2"></fmt:formatNumber></span>
                </div>
                <div class="promotionDiv">
                    <span class="promotionPriceDesc">促销价</span>
                    <span class="promotionPriceYuan">¥</span>
                    <span class="promotionPrice"><fmt:formatNumber type="number" value="${p.promotePrice}" minFractionDigits="2"></fmt:formatNumber></span>
                </div>
            </div>
        </div>

        <div class="productSaleAndReviewNumber">
            <div>销量<span class="redColor boldWord">${p.salesCount}</span></div>
