            ...
            <tbody>
                <c:forEach items="${pl}" var="p">
                    <tr>
                        <td>${p.id}</td>
                        <td>
                            <c:if test="${!empty p.imageId}">
                                <img src="img/productSingle/${p.imageId}.jpg" width="40px">
                            </c:if>
                        </td>
                        <td>${p.name}</td>
                        <td>${p.subTitle}</td>
        ...
        <div class="panel-body">
            <form method="post" id="addForm" action="admin_product_add">
                <table class="addTable">
                    <tr>
                        <td>产品名称</td>
                        <td><input type="text" id="product_name" name="name" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>产品小标题</td>
                    ...
                    <tr>
                        <td>原价格</td>
                        <td><input type="text" id="originalPrice" name="originalPrice" class="form-control" value="99.98"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td><input type="text" id="promotePrice" name="promotePrice" class="form-control" value="19.98"></td>
                    </tr>
                    <tr>
                        <td>库存</td>
                        <td><input type="text" id="stock" name="stock" class="form-control" value="100"></td>
                    </tr>
                    <tr class="submitTR">
